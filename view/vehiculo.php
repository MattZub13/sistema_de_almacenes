                    ...
                    <div class="page-title-box">
                        <div class="col-sm-6 col-md-3  mt-4">
                                        <div class="text-center">
                                            <!-- Small modal -->
                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-center">Nuevo Vehiculo</button>
                                        </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <label for="placa" class="col-sm-3 col-form-label">placa del Vehiculo: </label>
                                        <div class="col-sm-9 mt-2">
