        ...
        <div class="wrapper-page" >
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <form class="form-horizontal m-t-20" name="login" id="login" method="POST">

                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="form-control" type="email" required="" placeholder="Correo" name="correo" id="correo">
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center row m-t-20">
                                <div class="col-12">
                                    <button class="btn btn-login btn-block waves-effect waves-light" type="submit">Log In</button>
                                </div>
                            </div>
                        </form>
                    </div>
